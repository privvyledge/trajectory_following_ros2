...
class BicycleKinematicModel(object):
    ...
    def model_setup(self):
        ...
        # cost weight TVPs (runtime-updatable)
        Q_0 = model.set_variable(var_type="_tvp", var_name="Q_0")
        Q_1 = model.set_variable(var_type="_tvp", var_name="Q_1")
        Q_2 = model.set_variable(var_type="_tvp", var_name="Q_2")
        Q_3 = model.set_variable(var_type="_tvp", var_name="Q_3")
        R_0 = model.set_variable(var_type="_tvp", var_name="R_0")
        R_1 = model.set_variable(var_type="_tvp", var_name="R_1")
        Qf_0 = model.set_variable(var_type="_tvp", var_name="Qf_0")
        Qf_1 = model.set_variable(var_type="_tvp", var_name="Qf_1")
        Qf_2 = model.set_variable(var_type="_tvp", var_name="Qf_2")
        Qf_3 = model.set_variable(var_type="_tvp", var_name="Qf_3")
        Rd_0 = model.set_variable(var_type="_tvp", var_name="Rd_0")
